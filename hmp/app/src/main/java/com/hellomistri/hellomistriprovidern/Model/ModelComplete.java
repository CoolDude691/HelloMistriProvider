...
public class ModelComplete  implements Serializable {
    private String id;
    private String uid;
    private String cid;
    ...
    public ModelComplete(String id, String address, String odate, String time, String o_status,String services_cat,String add_desc,String uid) {
